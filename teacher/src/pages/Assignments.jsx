          ...
          <form onSubmit={handleSaveAssignment}>
            ...
            <div className="mb-3">
              ...
              <select
                ...
                onChange={(e) =>
                  setModalAssignment({ ...modalAssignment, subject: e.target.value })
                }
                required
              >
            ...
            <div className="mb-3">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setModalAssignment({ ...modalAssignment, description: e.target.value })
                }
              ></textarea>
            </div>
            <div className="mb-3">
              ...
              <input
                ...
                onChange={(e) =>
                  setModalAssignment({ ...modalAssignment, dueDate: e.target.value })
                }
              />
            </div>
            <div className="mb-3">
              ...
              <input
                ...
                onChange={(e) =>
                  setModalAssignment({ ...modalAssignment, maxMarks: e.target.value })
                }
              />
            </div>
            <div className="mb-3">
